...
do
  ...
  python ./paragraphvec/train.py start --data_file_name "${file_name}.csv" --num_epochs 50 --batch_size 32 --num_noise_words 2 --num_workers 8 --vec_dim $vec_dim_dbow --lr 1e-3
  python ./paragraphvec/train.py start --data_file_name "${file_name}.csv" --num_epochs 50 --batch_size 32 --num_noise_words 2 --num_workers 8 --vec_dim $vec_dim_dm --lr 1e-3 --model_ver dm --context_size 10
