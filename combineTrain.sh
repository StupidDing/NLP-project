...
conda activate base
python ./csv_combine.py "${file_name}_model.dbow_vecdim.${vec_dim_dbow}_intermed.csv" \
"${file_name}_model.dm_vecdim.${vec_dim_dm}_intermediate.tar" "${file_name}_vecdim.${vec_dim_dbow}.csv"
python ./testTrain.py "./data/${file_name}_vecdim.${vec_dim_dbow}.csv" ${dataset} ${vec_dim_dbow} ${vec_dim_dm}
