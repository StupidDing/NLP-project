...
def main():
    ...
    data_df = pandas.read_csv("./fakenews_test/bow_model.csv")
    label_df = pandas.read_csv("./fakenews_test/fakenews_label.csv")
    ...
    new_data = {'Dataset': "fakenews_base", 'Dim': 100, 'DimDBOW': -1, "DimDM": -1, "Accuracy": f"{accuracy:.2f}"}
